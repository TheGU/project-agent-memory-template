...
when trimmed. Split by lifecycle/scope: `AGENTS.md` (rules + gotchas + wiki index, always
loaded); `docs/ARCHITECTURE.md` + `docs/wiki/` (semantic, by scope); `docs/DECISIONS.md`
